...
export default function DisplayPOV() {
  let cid = "QmP52LMndDDHchUH5soxCeymda6bnx4t6G4PAzzHk3ibyA";
            ...
            <div className="md:w-3/5 md:basis-auto md:pl-8 lg:w-1/2 lg:pl-[3.75rem]">
              ...
              <div className="mb-3 flex">
                ...
                <div className="flex items-center">
                  <Link href="#">
                    <div className="text-accent mr-2 text-sm font-bold">{name}</div>
                  </Link>
                  <span
                ...
                <div className="ml-auto flex items-stretch space-x-2 relative">
                  ...
                  {/* <!-- Actions --> */}
                  {/* <Auctions_dropdown classes=" dropdown rounded-xl border bg-primary" /> */}
                </div>
              </div>
